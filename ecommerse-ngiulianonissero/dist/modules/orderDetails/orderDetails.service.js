...
let OrderDetailsService = class OrderDetailsService {
    ...
    async createOrderDetails(products, order) {
        return await this.orderDetailsRepository.createOrderDetails(products, order);
    }
};
exports.OrderDetailsService = OrderDetailsService;
exports.OrderDetailsService = OrderDetailsService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [orderDetails_repository_1.OrderDetailsRepository])
], OrderDetailsService);
